    ...
    <div>
      ...
      <div style={{ maxWidth: 500, margin: "0 auto", padding: "1rem 0.6rem" }}>
        <div className="animate-fade-in-up" style={cardStyle}>
          ...
          <div style={gridStyle}>
            <StatBox label={s.stages} value={`${stats.stagesCompleted}/${stats.totalStages}`} icon="📚" />
            <StatBox label={s.stars} value={`${stats.totalStars}/${stats.maxStars}`} icon="⭐" color="var(--gold)" />
            <StatBox
              label={s.successRate}
            ...
            <>
              <div style={{ marginTop: "1.25rem" }}>
                <div style={{ display: "flex", justifyContent: "space-between", fontSize: "0.8rem", marginBottom: "0.35rem" }}>
                  <span style={{ color: "var(--text-light)" }}>{s.overall}</span>
              ...
              {stats.totalStars > 0 && (
                ...
                >
                  <div style={{ fontSize: "0.8rem", color: "var(--text-light)" }}>
                    {stats.bestStage?.icon ?? ""} {s.bestStage}
                  </div>
